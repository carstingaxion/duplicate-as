...
module.exports = {
	...
	moduleNameMapper: {
		...
		'^@testing-library/react$': '<rootDir>/tests/__mocks__/@testing-library/react.js',
		'^@wordpress/i18n$': '<rootDir>/tests/__mocks__/@wordpress/i18n.js',
		'^@wordpress/api-fetch$': '<rootDir>/tests/__mocks__/@wordpress/api-fetch.js',
		...
		'^@wordpress/core-data$': '<rootDir>/tests/__mocks__/@wordpress/core-data.js',
		'^@wordpress/plugins$': '<rootDir>/tests/__mocks__/@wordpress/plugins.js',
	},
};
